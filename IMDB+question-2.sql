...
INNER JOIN top_3_genres ON g.genre = top_3_genres.genre
INNER JOIN ratings r ON d.movie_id = r.movie_id
WHERE r.avg_rating > 8 AND top_3_genres.genre_rank <= 3
GROUP BY n.name
